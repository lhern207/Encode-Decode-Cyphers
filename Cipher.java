/*
 * Defines and implements a general Cipher and its allowed operations.
 */
...
public abstract class Cipher implements Constants {
    ...
    public final void encrypt() { /* The message string is tokenized into 
    individual words, and each word is encoded by calling the encode method */
    ...
    public final void decrypt(String message) { /* The encoded message string
    is tokenized into individual words, and each word is encoded  by calling the
    decode method */ // Supply the code that will decrypt the encrypted string 
